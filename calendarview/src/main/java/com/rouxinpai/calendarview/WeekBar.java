 ...
 */
package com.rouxinpai.calendarview;
...
public class WeekBar extends LinearLayout {
    ...
    public WeekBar(Context context) {
        super(context);
        if ("com.rouxinpai.calendarview.WeekBar".equals(getClass().getName())) {
    ...
    void setup(CalendarViewDelegate delegate) {
        ...
        if ("com.rouxinpai.calendarview.WeekBar".equalsIgnoreCase(getClass().getName())) {
